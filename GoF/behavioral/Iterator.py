...
# Создаем интерфейс и обязуем его выплевывать унифицированные значения
class Iterator(ABC):
...
# Другой ИЗВРАЩЕННЫЙ способ - перегруженные методы init прямо в интерфейсе, без абсатркции, готовое решение
