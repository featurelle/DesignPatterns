...
# Задача: Посчитать расходы на замену всех деревянных окон в нескольких домах и заменить, если бюджет позволяет.
...
class VeryOldHouse(Iterable):
    ...
    #
    # И никакой третий вид Итератора был бы не нужен.
