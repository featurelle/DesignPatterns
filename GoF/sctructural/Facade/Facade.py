# Большое количество разнородных импортов уже намекает на возможную необходимость создания [1-inf] Фасадов
# Допустим, мы постоянно создаем какой-то однотипный запрос и отправляем на однотипный адрес.
