...
#  ну и сохранять промежуточные ответы на трудоемкие запросы, например парсинг каких-то страниц и тп
#  правда, в таком случае нагрузка переходит с временных затрат на память...
